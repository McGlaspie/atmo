...
//Random note:
//Look into infestation blobs, and see if their material can be an atlas
//have some blobs with emissive maps, and other with more tendrils.
//Four maps in total should do the job. Then randomize them on blob creation
//...just be sure the randomization doesn't make things look like patchwork crap.
...
elseif Client then
    ...
    Event.Hook("UpdateClient", UpdateDirtyTableClient, "Infestation")
